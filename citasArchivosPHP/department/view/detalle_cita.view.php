...
<h5 class="text-center pt-3 pb-3"><strong><i class="admin-icon fa fa-building"></i>Departamento: <?php echo utf8_encode($departamento['cdep_nombre']); ?></strong></h5>

<div class="container">
	<div class="row">
    <div class="contenedor_login col-10 offset-1 col-lg-6 offset-lg-3">
      <div class="contenido_login">
				<label for="matricula"><strong>Matrícula o RFC:</strong></label>
	...
	<div class="row options-below">
       ...
       <h5><a class="option" href="<?php echo RUTA; ?>/department"><i class="icono-left fa fa-mail-reply"></i>Volver</a></h5>
     </div>
   </div>
</div>
